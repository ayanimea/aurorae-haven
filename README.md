...
- **Optional backend integration draft**: [Backend integration requirements](./docs/BACKEND_REQUIREMENTS.md) (for future/custom sync work; local-first app works without backend auth)
